...
**Underscores prefixing the functions names:** If you ever wonder about strange underscores in the beginning of some functions, read [this](http://igorsobreira.com/2010/09/16/difference-between-one-underline-and-two-underlines-in-python.html).

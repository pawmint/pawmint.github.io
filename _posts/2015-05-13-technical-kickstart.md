...
Our team bought virtual machines on Amazon, those are located in Amsterdam and Singapore. This allow them to connect and work from their local machine (used as a simple interface) on their virtual machines (which processes the programs).
